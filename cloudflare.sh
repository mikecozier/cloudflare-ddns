...
auth_email="example@hotmail.com"                 # The email used to login 'https://dash.cloudflare.com'
auth_method="global"                                # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="api token here"    # Your API Token or Global API Key
zone_identifier="zone identifier here"  # Can be found in the "Overview" tab of your domain
record_name="yourdomainhere.com"                  # Which record you want to be synced
